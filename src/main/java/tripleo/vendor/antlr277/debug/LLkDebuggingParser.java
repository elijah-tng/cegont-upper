...
public class LLkDebuggingParser extends LLkParser implements DebuggingParser {
    ...
    public void match(int t) throws MismatchedTokenException, TokenStreamException {
        ...
        try {
            ...
            if (inputState.guessing == 0) parserEventSupport.fireMismatch(la_1, t, text, inputState.guessing);
            throw e;
        }
    }
    ...
    public void matchNot(int t) throws MismatchedTokenException, TokenStreamException {
        ...
        try {
            ...
            if (inputState.guessing == 0) parserEventSupport.fireMismatchNot(la_1, t, text, inputState.guessing);
            throw e;
        }
    }
    ...
    protected void fireExitRule(int num, int data) {
        if (isDebugMode()) parserEventSupport.fireExitRule(num, inputState.guessing, data);
    }
    ...
    protected void setupDebugging(TokenStream lexer, TokenBuffer tokenBuf) {
        ...
        try {
            ...
            Class c = Utils.loadClass("tripleo.vendor.antlr277.parseview.ParseView");
            Constructor constructor =
                    c.getConstructor(new Class[] {LLkDebuggingParser.class, TokenStream.class, TokenBuffer.class});
