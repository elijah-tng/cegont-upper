...
public class ParserEventSupport {
    ...
    public void fireEvents(int type, Vector listeners) {
        ...
        if (controller != null) controller.checkBreak();
    }
    ...
    public void fireExitRule(int ruleNum, int guessing, int data) {
        ...
        ruleDepth--;
        if (ruleDepth == 0) fireDoneParsing();
    }
    ...
    protected void refresh(Vector listeners) {
        ...
        if (v != null) for (int i = 0; i < v.size(); i++) ((ListenerBase) v.elementAt(i)).refresh();
    }

    public void removeNewLineListener(NewLineListener l) {
        if (newLineListeners != null) newLineListeners.removeElement(l);
    ...
    public void removeDoneListener(ListenerBase l) {
        ...
        if (val == 0) doneListeners.remove(l);
        else doneListeners.put(l, new Integer(val));
    }
    ...
    public void removeParserMatchListener(ParserMatchListener l) {
        if (matchListeners != null) matchListeners.removeElement(l);
        removeDoneListener(l);
    }

    public void removeMessageListener(MessageListener l) {
        if (messageListeners != null) messageListeners.removeElement(l);
        removeDoneListener(l);
    }

    public void removeParserTokenListener(ParserTokenListener l) {
        if (tokenListeners != null) tokenListeners.removeElement(l);
        removeDoneListener(l);
    }

    public void removeTraceListener(TraceListener l) {
        if (traceListeners != null) traceListeners.removeElement(l);
        removeDoneListener(l);
    }

    public void removeSemanticPredicateListener(SemanticPredicateListener l) {
        if (semPredListeners != null) semPredListeners.removeElement(l);
        removeDoneListener(l);
    }

    public void removeSyntacticPredicateListener(SyntacticPredicateListener l) {
        if (synPredListeners != null) synPredListeners.removeElement(l);
        removeDoneListener(l);
    }
}
