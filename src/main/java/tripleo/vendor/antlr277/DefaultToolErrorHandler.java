...
class DefaultToolErrorHandler implements ToolErrorHandler {
    private final tripleo.vendor.antlr277.Tool antlrTool;
    CharFormatter javaCharFormatter = new JavaCharFormatter();

    DefaultToolErrorHandler(tripleo.vendor.antlr277.Tool tool) {
        antlrTool = tool;
    }
     ...
     * {@link tripleo.vendor.antlr277.Tool.warning(String[], String, int, int)
