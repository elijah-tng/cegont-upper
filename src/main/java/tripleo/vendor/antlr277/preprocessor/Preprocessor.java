...
public class Preprocessor extends tripleo.vendor.antlr277.LLkParser implements PreprocessorTokenTypes {
    ...
    private tripleo.vendor.antlr277.Tool antlrTool;
                ...
                do {
                    if ((LA(1) == ID)) {
                        ...
                        if (gr != null && op.getText().equals("importVocab")) {
                            ...
                            gr.exportVocab =
                                    rhs.getText().substring(0, rhs.getText().length() - 1);
    ...
    public final Grammar class_def(String file, Hierarchy hier) throws RecognitionException, TokenStreamException {
        ...
        try { // for error handling
            ...
            if (gr != null) {
                //				tripleo.vendor.antlr277.Tool.toolError("redefinition of grammar "+gr.getName()+" ignored");
                gr = null;
                throw new SemanticException(
                        "redefinition of grammar " + sub.getText(), file, sub.getLine(), sub.getColumn());
            } else {
