 ...
 *
 * $Id: //depot/code/org.antlr/release/antlr-2.7.7/antlr/preprocessor/Grammar.java#2 $
 */
...
class Grammar {
    ...
    public Grammar(tripleo.vendor.antlr277.Tool tool, String name, String superGrammar, IndexedVector rules) {
        this.name = name;
    ...
    public void expandInPlace() {
        ...
        if ((options != null && options.getElement("importVocab") == null) || options == null) {
            ...
            String superExportVocabFileName = path
                    + superG.exportVocab
                    + tripleo.vendor.antlr277.CodeGenerator.TokenTypesFileSuffix
                    + tripleo.vendor.antlr277.CodeGenerator.TokenTypesFileExt;
    ...
    public void inherit(Rule r, Grammar superG) {
        ...
        if (overriddenRule != null) {
            ...
            if (!overriddenRule.sameSignature(r)) {
                ...
                antlrTool.warning(
                        "rule " + getName() + "." + overriddenRule.getName() + " has different signature than "
                                + superG.getName()
    ...
    public String toString() {
        ...
        for (int i = 0; i < rules.size(); i++) {
            ...
            if (!getName().equals(r.enclosingGrammar.getName())) {
                s.append("// inherited from grammar " + r.enclosingGrammar.getName()
