 ...
 * @version 2.00a
 * @see     tripleo.vendor.antlr277.JavaCodeGenerator
 * @see     tripleo.vendor.antlr277.DiagnosticCodeGenerator
 * @see     tripleo.vendor.antlr277.LLkAnalyzer
 * @see     tripleo.vendor.antlr277.Grammar
 * @see     tripleo.vendor.antlr277.AlternativeElement
 * @see     tripleo.vendor.antlr277.Lookahead
 */
public abstract class CodeGenerator {
    ...
    protected transient PrintWriter currentOutput; // SAS: for proper text i/o
    ...
    protected void genTokenInterchange(TokenManager tm) throws IOException {
        ...
        println("// $ANTLR " + antlrTool.version + ": " + antlrTool.fileMinusPath(antlrTool.grammarFile)
                + " -> "
                + fName
                + "$");
     ...
     */
    protected abstract String processActionForSpecialSymbols(
    ...
    protected void setGrammar(Grammar g) {
        ...
        if (grammar.hasOption("codeGenDebug")) {
            ...
            if (t.getText().equals("true")) {
                ...
                antlrTool.error(
                        "option 'codeGenDebug' must be true or false",
                        grammar.getClassName(),
                        t.getLine(),
                        t.getColumn());
            }
