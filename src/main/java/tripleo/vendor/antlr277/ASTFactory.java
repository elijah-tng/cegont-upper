...
public class ASTFactory {
     ...
     *  via the ASTFactory(Hashtable) ctor in tripleo.vendor.antlr277.Parser.
     */
     ...
     *  a prior dependency on class tripleo.vendor.antlr277.Tool.
     */
    ...
    protected AST createUsingCtor(Token token, String className) {
        ...
        try {
            c = Utils.loadClass(className);
            Class[] tokenArgType = new Class[] {tripleo.vendor.antlr277.Token.class};
            try {
