 ...
 * <p>
 *
 * @see tripleo.vendor.antlr277.Token
 * @see tripleo.vendor.antlr277.Tokenizer
 * @see tripleo.vendor.antlr277.TokenQueue
 */
...
public class TokenBuffer {
    ...
    public final int mark() {
        ...
        // try { for (int i = 1; i <= 2; i++) { System.out.println("LA("+i+")=="+LT(i).getText()); } } catch
        // (ScannerException e) {}
        nMarkers++;
        return markerOffset;
    }
