...
public class Tool {
    ...
    public static void main(String[] args) {
        System.err.println("ANTLR Parser Generator   Version " + Version.project_version + "   1989-2005");
        ...
        try {
            ...
            System.err.println(" or send hate-mail to parrt@tripleo.vendor.antlr277.org;");
    ...
    private static void help() {
        System.err.println("usage: java tripleo.vendor.antlr277.Tool [args] file.g");
    ...
    public int doEverything(String[] args) {
        ...
        tripleo.vendor.antlr277.preprocessor.Tool preTool = new tripleo.vendor.antlr277.preprocessor.Tool(this, args);
        ...
        try {
            ...
            String codeGenClassName = "tripleo.vendor.antlr277." + getLanguage(behavior) + "CodeGenerator";
            try {
    ...
    public static Vector parseSeparatedList(String list, char separator) {
        java.util.StringTokenizer st = new java.util.StringTokenizer(list, String.valueOf(separator));
    ...
    public void setNameSpace(String name) {
        if (null == nameSpace) nameSpace = new NameSpace(StringUtils.stripFrontBack(name, "\"", "\""));
    }
