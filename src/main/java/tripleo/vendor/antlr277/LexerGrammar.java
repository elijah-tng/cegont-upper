...
class LexerGrammar extends Grammar {
    ...
    public String getSuperClass() {
        ...
        if (debuggingOutput) return "debug.DebuggingCharScanner";
        return "CharScanner";
    }
    ...
    public boolean setOption(String key, Token value) {
        ...
        if (key.equals("buildAST")) {
            antlrTool.warning(
                    "buildAST option is not valid for lexer", getFilename(), value.getLine(), value.getColumn());
            return true;
        }
        if (key.equals("testLiterals")) {
            if (s.equals("true")) {
                ...
                antlrTool.warning(
                        "testLiterals option must be true or false", getFilename(), value.getLine(), value.getColumn());
            }
            return true;
        }
        if (key.equals("interactive")) {
            if (s.equals("true")) {
                ...
                antlrTool.error(
                        "interactive option must be true or false", getFilename(), value.getLine(), value.getColumn());
            }
            return true;
        }
