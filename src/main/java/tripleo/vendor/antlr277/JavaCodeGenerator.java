...
import tripleo.vendor.antlr277.actions.java.*;
...
public class JavaCodeGenerator extends CodeGenerator {
    ...
    public void gen(ActionElement action) {
        ...
        try {
            ...
            if (action.isSemPred) {
                ...
                String actionStr =
                        processActionForSpecialSymbols(action.actionText, action.getLine(), currentRule, tInfo);
                ...
                if (tInfo.assignToRoot) {
                    ...
                    println(
                            "currentAST.child = " + tInfo.refRuleRoot + "!=null &&" + tInfo.refRuleRoot
                                    + ".getFirstChild()!=null ?",
                            NO_MAPPING);
                    tabs++;
    ...
    public JavaCodeGeneratorPrintWriterManager getPrintWriterManager() {
        if (printWriterManager == null) printWriterManager = new DefaultJavaCodeGeneratorPrintWriterManager();
    ...
    public void gen(LexerGrammar g) throws IOException {
        ...
        try {
            ...
            println("import tripleo.vendor.antlr277.TokenStreamException;");
            println("import tripleo.vendor.antlr277.TokenStreamIOException;");
            println("import tripleo.vendor.antlr277.TokenStreamRecognitionException;");
            println("import tripleo.vendor.antlr277.CharStreamException;");
            println("import tripleo.vendor.antlr277.CharStreamIOException;");
            println("import tripleo.vendor.antlr277.ANTLRException;");
            println("import java.io.Reader;");
            println("import java.util.Hashtable;");
            println("import tripleo.vendor.antlr277." + grammar.getSuperClass() + ";");
            println("import tripleo.vendor.antlr277.InputBuffer;");
            println("import tripleo.vendor.antlr277.ByteBuffer;");
            println("import tripleo.vendor.antlr277.CharBuffer;");
            println("import tripleo.vendor.antlr277.Token;");
            println("import tripleo.vendor.antlr277.CommonToken;");
            println("import tripleo.vendor.antlr277.RecognitionException;");
            println("import tripleo.vendor.antlr277.NoViableAltForCharException;");
            println("import tripleo.vendor.antlr277.MismatchedCharException;");
            println("import tripleo.vendor.antlr277.TokenStream;");
            println("import tripleo.vendor.antlr277.ANTLRHashString;");
            println("import tripleo.vendor.antlr277.LexerSharedInputState;");
            println("import tripleo.vendor.antlr277.collections.impl.BitSet;");
            println("import tripleo.vendor.antlr277.SemanticException;");
            ...
            if (grammar.superClass != null) {
                ...
                sup = "tripleo.vendor.antlr277." + grammar.getSuperClass();
            }
            ...
            if (grammar.debuggingOutput)
                println("this(new LexerSharedInputState(new tripleo.vendor.antlr277.debug.DebuggingInputBuffer(ib)));");
    ...
    public void gen(ParserGrammar g) throws IOException {
        ...
        try {
            ...
            println("import tripleo.vendor.antlr277.TokenBuffer;");
            println("import tripleo.vendor.antlr277.TokenStreamException;");
            println("import tripleo.vendor.antlr277.TokenStreamIOException;");
            println("import tripleo.vendor.antlr277.ANTLRException;");
            println("import tripleo.vendor.antlr277." + grammar.getSuperClass() + ";");
            ...
            println("import tripleo.vendor.antlr277.TokenStream;");
            println("import tripleo.vendor.antlr277.RecognitionException;");
            println("import tripleo.vendor.antlr277.NoViableAltException;");
            println("import tripleo.vendor.antlr277.MismatchedTokenException;");
            println("import tripleo.vendor.antlr277.SemanticException;");
            println("import tripleo.vendor.antlr277.ParserSharedInputState;");
            println("import tripleo.vendor.antlr277.collections.impl.BitSet;");
            if (genAST) {
                println("import tripleo.vendor.antlr277.collections.AST;");
                println("import java.util.Hashtable;");
                println("import tripleo.vendor.antlr277.ASTFactory;");
                println("import tripleo.vendor.antlr277.ASTPair;");
                println("import tripleo.vendor.antlr277.collections.impl.ASTArray;");
            }
            ...
            else sup = "tripleo.vendor.antlr277." + grammar.getSuperClass();
            ...
            if (tsuffix != null) {
                String suffix = StringUtils.stripFrontBack(tsuffix.getText(), "\"", "\"");
                if (suffix != null) print(", " + suffix); // must be an interface name for Java
            }
            println(" {");
    ...
    public void gen(RuleRefElement rr) {
        ...
        try {
            ...
            if (rs == null || !rs.isDefined()) {
                // Is this redundant???
                antlrTool.error(
                        "Rule '" + rr.targetRule + "' is not defined",
                        grammar.getFilename(),
                        rr.getLine(),
                        rr.getColumn());
                return;
            ...
            if (rr.idAssign != null) {
                ...
                if (rs.block.returnAction == null) {
                    antlrTool.warning(
                            "Rule '" + rr.targetRule + "' has no return type",
                            grammar.getFilename(),
                            rr.getLine(),
                            rr.getColumn());
                }
    ...
    public void gen(TreeElement t) {
        ...
        try {
            ...
            if (t.root.getLabel() != null) {
                println(
                        t.root.getLabel() + " = _t==ASTNULL ? null :(" + labeledElementASTType + ")_t;",
                        t.root.getLine());
            }
    ...
    protected String processActionForSpecialSymbols(
        ...
        if ((grammar.buildAST && actionStr.indexOf('#') != -1)
                ...
                || ((grammar instanceof LexerGrammar || grammar instanceof ParserGrammar)
                        && actionStr.indexOf('$') != -1)) {
            // Create a lexer to read an action and return the translated version
            ActionLexer lexer =
                    new ActionLexer(actionStr, currentRule, this, tInfo);
    ...
    protected void genAlt(Alternative alt, AlternativeBlock blk) {
        ...
        if (genAST) {
            if (blk instanceof RuleBlock) {
                ...
                println(
                        rblk.getRuleName() + "_AST = (" + labeledElementASTType + ")currentAST.root;",
                ...
                antlrTool.warning(
                        "Labeled subrules not yet supported", grammar.getFilename(), blk.getLine(), blk.getColumn());
            }
        }
    ...
    private void genBitSet(BitSet p, int id) {
        ...
        try {
            ...
            println("}");
            // BitSet object
            println("public static final BitSet " + getBitsetName(id) + " = new BitSet(" + "mk"
                    + getBitsetName(id) + "()" + ");");
        } finally {
            defaultLine = oldDefaultLine;
        }
    ...
    protected void genBlockInitAction(AlternativeBlock blk) {
        ...
        if (blk.initAction != null) {
            printAction(
                    processActionForSpecialSymbols(blk.initAction, blk.getLine(), currentRule, null), blk.getLine());
        }
    }
                        ...
                        if (a instanceof RuleRefElement
                            ...
                            if (!(a instanceof RuleRefElement)
                                    ...
                                    && analyzer.subruleCanBeInverted(
                                            ((AlternativeBlock) a), grammar instanceof LexerGrammar)) {
                ...
                for (int i = 0; i < blk.alternatives.size(); i++) {
                    ...
                    if (grammar instanceof LexerGrammar) {
                        ...
                        if (effectiveDepth != altDepth) {
                            if (DEBUG_CODE_GENERATOR)
                                System.out.println("ignoring alt because effectiveDepth!=altDepth;" + effectiveDepth
                                        + "!=" + altDepth);
                            continue;
                        }
                    ...
                    try {
                        ...
                        if (alt.cache[1].fset.degree() > caseSizeThreshold && suitableForCaseExpression(alt)) {
                            if (nIF == 0) {
                                println("if " + e + " {");
                            } else {
                                println("else if " + e + " {");
                            ...
                            if (alt.semPred != null) {
                                ...
                                ActionTransInfo tInfo = new ActionTransInfo();
                                String actionStr =
                                        processActionForSpecialSymbols(alt.semPred, blk.line, currentRule, tInfo);
                                ...
                                if (((grammar instanceof ParserGrammar) || (grammar instanceof LexerGrammar))
                                    ...
                                    e = "(" + e
                                            + "&& fireSemanticPredicateEvaluated(tripleo.vendor.antlr277.debug.SemanticPredicateEvent.PREDICTING,"
    ...
    private void genElementAST(AlternativeElement el) {
        ...
        try {
            ...
            if (grammar.buildAST && syntacticPredLevel == 0) {
                boolean needASTDecl =
                        (genAST && (el.getLabel() != null || el.getAutoGenType() != GrammarElement.AUTO_GEN_BANG));
                ...
                if (el.getAutoGenType() != GrammarElement.AUTO_GEN_BANG && (el instanceof TokenRefElement)) {
                    needASTDecl = true;
                }
        ...
        for (int i = 0; i < ex.handlers.size(); i++) {
            ...
            try {
                ...
                printAction(processActionForSpecialSymbols(
                        handler.action.getText(), handler.action.getLine(), currentRule, tInfo));
    ...
    protected void genASTDeclaration(AlternativeElement el, String var_name, String node_type) {
        // already declared?
        if (declaredASTVariables.contains(el)) return;
            ...
            if (((LexerGrammar) grammar).filterMode) {
                if (filterRule == null) {
                    ...
                    errFinish += "else {" + newline + "\t\t\t\t\tcommit();"
                            + newline + "\t\t\t\t\ttry {m"
                            + filterRule + "(false);}" + newline + "\t\t\t\t\tcatch(RecognitionException e) {"
                            + newline + "\t\t\t\t\t	// catastrophic failure"
                            + newline + "\t\t\t\t\t	reportError(e);"
                            + newline + "\t\t\t\t\t	consume();"
                            + newline + "\t\t\t\t\t}"
    ...
    public void genRule(RuleSymbol s, boolean startSymbol, int ruleNum) {
        ...
        try {
            ...
            if (grammar.debuggingOutput)
                if (grammar instanceof ParserGrammar) println("fireEnterRule(" + ruleNum + ",0);");
            ...
            if (grammar instanceof TreeWalkerGrammar) {
                ...
                println(
                        labeledElementASTType + " " + s.getId() + "_AST_in = (_t == ASTNULL) ? null : ("
            ...
            if (grammar.debuggingOutput || grammar.traceRules) {
                ...
                if (grammar.debuggingOutput)
                    if (grammar instanceof ParserGrammar) println("fireExitRule(" + ruleNum + ",0);");
        ...
        try {
            ...
            if (rr.args != null) {
                ...
                if (tInfo.assignToRoot || tInfo.refRuleRoot != null) {
                    antlrTool.error(
                            "Arguments of rule reference '" + rr.targetRule + "' cannot set or ref #"
                ...
                if (rs.block.argAction == null) {
                    antlrTool.warning(
                            "Rule '" + rr.targetRule + "' accepts no arguments",
                            grammar.getFilename(),
                            rr.getLine(),
                            rr.getColumn());
                }
                ...
                if (rs.block.argAction != null) {
                    antlrTool.warning(
                            "Missing parameters on reference to rule " + rr.targetRule,
                            grammar.getFilename(),
                            rr.getLine(),
                            rr.getColumn());
                }
    ...
    protected void genSemPred(String pred, int line) {
        ...
        if (grammar.debuggingOutput && ((grammar instanceof ParserGrammar) || (grammar instanceof LexerGrammar)))
            pred = "fireSemanticPredicateEvaluated(tripleo.vendor.antlr277.debug.SemanticPredicateEvent.VALIDATING,"
    ...
    protected void genSemPredMap() {
        ...
        while (e.hasMoreElements()) println("\"" + e.nextElement() + "\",", NO_MAPPING);
        println("};", NO_MAPPING);
    }
    ...
    public String getASTCreateString(String astCtorArgs) {
        ...
        if (nCommas < 2) { // if 1 or 2 args
            ...
            if (ts != null) {
                ...
                if (astNodeType != null) {
                    return "(" + astNodeType + ")" + "astFactory.create(" + astCtorArgs + emptyText + ",\""
                            + astNodeType + "\")";
                }
    ...
    public String getRangeExpression(int k, int[] elems) {
        ...
        return "(" + lookaheadString(k) + " >= " + getValueString(begin) + " && " + lookaheadString(k) + " <= "
                + getValueString(end) + ")";
    }
