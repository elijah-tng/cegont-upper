...
public class DiagnosticCodeGenerator extends CodeGenerator {
    ...
    public void gen(LexerGrammar g) throws IOException {
        ...
        println("");
        println("*** Your lexer class is called '" + grammar.getClassName() + "' and is a subclass of '"
    ...
    public void gen(ParserGrammar g) throws IOException {
        ...
        println("");
        println("*** Your parser class is called '" + grammar.getClassName() + "' and is a subclass of '"
                + grammar.getSuperClass() + "'.");
    ...
    public void gen(TreeWalkerGrammar g) throws IOException {
        ...
        println("");
        println("*** Your tree-walker class is called '" + grammar.getClassName() + "' and is a subclass of '"
                + grammar.getSuperClass() + "'.");
    ...
    public void genRule(RuleSymbol s) {
        ...
        if (unlabeledUserSpec != null) {
            ...
            for (int i = 0; i < unlabeledUserSpec.handlers.size(); i++) {
                ...
                println("Error-handler(" + (i + 1) + ") catches [" + handler.exceptionTypeAndName.getText()
                        + "] and executes:");
