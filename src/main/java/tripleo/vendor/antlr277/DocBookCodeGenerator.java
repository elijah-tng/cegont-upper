...
public class DocBookCodeGenerator extends CodeGenerator {
    ...
    public void gen(LexerGrammar g) throws IOException {
        ...
        println("<para>Definition of lexer " + grammar.getClassName() + ", which is a subclass of "
                + grammar.getSuperClass() + ".</para>");
    ...
    public void gen(ParserGrammar g) throws IOException {
        ...
        println("<para>Definition of parser " + grammar.getClassName() + ", which is a subclass of "
                + grammar.getSuperClass() + ".</para>");
    ...
    public void gen(TreeWalkerGrammar g) throws IOException {
        ...
        println("<para>Definition of tree parser " + grammar.getClassName() + ", which is a subclass of "
                + grammar.getSuperClass() + ".</para>");
    ...
    public void genCommonBlock(AlternativeBlock blk) {
        if (blk.alternatives.size() > 1) println("<itemizedlist mark=\"none\">");
        for (int i = 0; i < blk.alternatives.size(); i++) {
            Alternative alt = blk.getAlternativeAt(i);
            AlternativeElement elem = alt.head;

            if (blk.alternatives.size() > 1) print("<listitem><para>");
            ...
            if (blk.alternatives.size() > 1) _println("</para></listitem>");
        }
        if (blk.alternatives.size() > 1) println("</itemizedlist>");
    }
