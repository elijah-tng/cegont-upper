// $ANTLR 2.7.3rc3: "tripleo.vendor.antlr277.g" -> "ANTLRParser.java"$

package tripleo.vendor.antlr277;

import tripleo.vendor.antlr277.collections.impl.*;

public class ANTLRParser extends tripleo.vendor.antlr277.LLkParser implements ANTLRTokenTypes {
    ...
    private void checkForMissingEndRule(Token label) {
        if (label.getColumn() == 1) {
            antlrTool.warning(
                    "did you forget to terminate previous rule?", getFilename(), label.getLine(), label.getColumn());
        }
    }
                ...
                case LITERAL_lexclass: {
                    ...
                    if (inputState.guessing == 0) {
                        ...
                        antlrTool.warning(
                                ...
                                lc.getLine(),
                                lc.getColumn());
                        //				System.out.println("warning: line " + lc.getLine() + ": 'lexclass' is deprecated; use
                        // 'class X extends Lexer'");
            ...
            switch (LA(1)) {
                ...
                case SEMI: {
                    if (inputState.guessing == 0) {
                        ...
                        antlrTool.warning(
                                "use 'class X extends Parser'", getFilename(), idTok.getLine(), idTok.getColumn());
