...
package tripleo.vendor.antlr277.actions.java;
 ...
 */
public class ActionLexer extends tripleo.vendor.antlr277.CharScanner implements ActionLexerTokenTypes, TokenStream {
        ...
        }
        {
            switch (LA(1)) {
                ...
                case ']': {
                    ...
                    {
                        if (((_tokenSet_15.member(LA(1))) && (_tokenSet_16.member(LA(2))) && (true))
