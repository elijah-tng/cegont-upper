...
import tripleo.vendor.org.apache.commons.lang3.Functions.FailableConsumer;
import tripleo.vendor.org.apache.commons.lang3.Functions.FailableFunction;
import tripleo.vendor.org.apache.commons.lang3.Functions.FailablePredicate;
 ...
 * @see Stream
 * @since 3.10
 * @deprecated Use {@link tripleo.vendor.org.apache.commons.lang3.stream.Streams}.
 */
@Deprecated
public class Streams {
     ...
     * @deprecated Use {@link tripleo.vendor.org.apache.commons.lang3.stream.Streams.ArrayCollector}.
     */
    @Deprecated
     ...
     * @param <O> The streams element type.
     * @deprecated Use {@link tripleo.vendor.org.apache.commons.lang3.stream.Streams.FailableStream}.
     */
    @Deprecated
    public static class FailableStream<O> {
        ...
        public FailableStream<O> filter(final FailablePredicate<O, ?> predicate) {
            assertNotTerminated();
            stream = stream.filter(Functions.asPredicate((Functions.FailablePredicate<? super O, ?>) predicate));
            return this;
        }
        ...
        public void forEach(final FailableConsumer<O, ?> action) {
            makeTerminated();
            stream().forEach(Functions.asConsumer((Functions.FailableConsumer<? super O, ?>) action));
        }
