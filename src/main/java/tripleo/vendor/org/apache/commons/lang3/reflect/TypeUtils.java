 ...
 */
package tripleo.vendor.org.apache.commons.lang3.reflect;

import tripleo.vendor.org.apache.commons.lang3.*;
import tripleo.vendor.org.apache.commons.lang3.builder.*;
...
public class TypeUtils {
     ...
     *
     * <p>
     * Example: {@link TreeSet TreeSet} sets its parameter as the parameter for {@link java.util.NavigableSet NavigableSet}, which in turn sets the
     * parameter of {@link java.util.SortedSet}, which in turn sets the parameter of {@link Set}, which in turn sets the parameter of
     * {@link Collection}, which in turn sets the parameter of {@link Iterable}. Since {@link TreeSet}'s parameter maps (indirectly) to
     ...
     * {@link Set Set} and {@link Collection Collection}), this method will look at the inheritance hierarchy of only one of the
