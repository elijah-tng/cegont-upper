 ...
 */
package tripleo.vendor.org_jdeferred2.impl;

import tripleo.vendor.org_jdeferred2.*;
...
public class FilteredPromise<D, F, P, D_OUT, F_OUT, P_OUT> extends DeferredObject<D_OUT, F_OUT, P_OUT> implements Promise<D_OUT, F_OUT, P_OUT>{
	...
	public FilteredPromise(final Promise<D, F, P> promise,
		...
		this.doneFilter = doneFilter == null ? NO_OP_DONE_FILTER : (DoneFilter<D, D_OUT>) doneFilter;
		this.failFilter = failFilter == null ? NO_OP_FAIL_FILTER : (FailFilter<F, F_OUT>) failFilter;
		this.progressFilter = progressFilter == null ? NO_OP_PROGRESS_FILTER : (ProgressFilter<P, P_OUT>) progressFilter;
