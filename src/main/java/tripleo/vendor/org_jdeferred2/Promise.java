 ...
 */
package tripleo.vendor.org_jdeferred2;
...
public interface Promise<D, F, P> {
	 ...
	 *
	 * @param doneFilter the filter to execute when a result is available.
	 *                      If {@code null}, use {@link tripleo.vendor.org_jdeferred2.impl.FilteredPromise.NoOpDoneFilter}
	 * @param failFilter the filter to execute when a failure is available.
	 *                      If {@code null}, use {@link tripleo.vendor.org_jdeferred2.impl.FilteredPromise.NoOpFailFilter}
	 * @param progressFilter the filter to execute when progress info is available.
	 *                          If {@code null}, use {@link tripleo.vendor.org_jdeferred2.impl.FilteredPromise.NoOpProgressFilter}
